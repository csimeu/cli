...
function postgresql_install() 
{
    ...
    echo "export PATH=$PATH:$PG_BIN" | sudo tee -a /etc/profile.d/postgresql.sh
    echo "export PG_DATA=$data" | sudo tee -a /etc/profile.d/postgresql.sh
    echo "export PG_LOG=$log" | sudo tee -a /etc/profile.d/postgresql.sh
...
postgresql_ctl(){
    ...
    if [ -f /usr/lib/postgresql/${version}/bin ]; then
