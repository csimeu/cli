...
POSTGRESQL_DEFAULT_VERSION=${POSTGRESQL_DEFAULT_VERSION:-"11"}
POSTGIS_DEFAULT_VERSION=${POSTGIS_DEFAULT_VERSION:-"2.4"}
...
MYSQL_RELEASES="5 8"
MYSQL_DEFAULT_VERSION=${MYSQL_DEFAULT_VERSION:-"5"}
